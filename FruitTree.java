public class FruitTree extends FarmSeeds{
    
    /** Creates a FruitTree object
     * 
     * @param name                the name
     ...
     */
    public FruitTree(String name, /*String cropType,*/ int harvestTime, int waterNeeds, int waterLimit, int fertilizerNeeds, int fertilizerLimit, int minProductsProduced, int maxProductsProduced, int seedCost, int sellingPrice, double expYield) {
        super(name, "Fruit Tree", harvestTime, waterNeeds, waterLimit, fertilizerNeeds, fertilizerLimit, minProductsProduced, maxProductsProduced, seedCost, sellingPrice, expYield);
    }
